...
import com.google.marscoin.store.MemoryBlockStore;
 ...
 *
 * <a href="http://www.marscoin.org/smf/index.php?topic=3638.0">http://www.marscoin.org/smf/index.php?topic=3638
 * .0</a><p>
 *
...
public class PrivateKeys {
    public static void main(String[] args) throws Exception {
        ...
        try {
            // Decode the private key from Satoshis Base58 variant. If 51 characters long then it's from marscoins
            ...
            // And take them!
            System.out.println("Claiming " + Utils.marscoinValueToFriendlyString(wallet.getBalance()) + " coins");
