...
package com.google.marscoin.examples.toywallet;
...
import com.google.marscoin.store.H2FullPrunedBlockStore;
...
public class ToyWallet {
            ...
            switch (col) {
                ...
                case 2:
                    try {
                        ...
                        return Utils.marscoinValueToFriendlyString(val);
    ...
    public ToyWallet(boolean testnet, boolean fullChain, String[] args) throws Exception {
        // Set up a marscoin connection + empty wallet. TODO: Simplify the setup for this use case.
        if (testnet) {
    ...
    private void setupWindow(JFrame window) {
        ...
        networkStats = new JLabel("Connecting to the marscoin network ...");
