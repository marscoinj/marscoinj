...
package com.google.marscoin.examples;

import com.google.marscoin.core.*;
import com.google.marscoin.crypto.KeyCrypterException;
import com.google.marscoin.discovery.DnsDiscovery;
import com.google.marscoin.discovery.IrcDiscovery;
import com.google.marscoin.store.BlockStore;
import com.google.marscoin.store.SPVBlockStore;
import com.google.marscoin.utils.BriefLogFormatter;
 ...
 * <li>Start your marscoin client in test mode <code>marscoin -testnet</code>. This will create a new sub-directory called testnet and should not interfere with normal wallets or operations.</li>
 * <li>(Optional) Choose a fresh address</li>
 * <li>(Optional) Visit the Testnet faucet (https://testnet.freemarscoins.appspot.com/) to load your client with test coins</li>
 * <li>Run <code>PingService testnet</code></li>
 * <li>Wait for the block chain to download</li>
 * <li>Send some coins from your marscoin client to the address provided in the PingService console</li>
 ...
 * .net/projects/marscoin/files/marscoin/testnet-in-a-box/">testnet in a box</a> to do everything purely locally.</p>
 */
public class PingService {
    ...
    public PingService(String[] args) throws Exception {
        ...
        if (testNet) {
            peerGroup.addPeerDiscovery(new IrcDiscovery("#marscoinTEST3"));
        } else {
        ...
        wallet.addEventListener(new AbstractWalletEventListener() {
            ...
            public void onCoinsReceived(Wallet w, Transaction tx, BigInteger prevBalance, BigInteger newBalance) {
                ...
                System.out.println("Received pending tx for " + Utils.marscoinValueToFriendlyString(value) +
                        ": " + tx);
    ...
    private void bounceCoins(final Wallet wallet, Transaction tx) {
        // It's impossible to pick one specific identity that you receive coins from in marscoin as there
        ...
        try {
            ...
            System.out.println("Received " + Utils.marscoinValueToFriendlyString(value) + " from " + from.toString());
