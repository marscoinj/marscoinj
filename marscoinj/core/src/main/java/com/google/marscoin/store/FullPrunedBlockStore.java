...
import com.google.marscoin.core.StoredTransactionOutput;
import com.google.marscoin.core.StoredUndoableBlock;
 ...
 * marscoin serialization of the block header, <b>not</b> the header with the extra data as well.</p>
 * 
 * <p>A FullPrunedBlockStore also contains a map of hash+index to StoredTransactionOutput.  Again, the hash is
 * a standard marscoin double-SHA256 hash of the transaction.</p>
 *
