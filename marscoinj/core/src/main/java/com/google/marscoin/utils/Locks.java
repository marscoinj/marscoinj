...
package com.google.marscoin.utils;
...
/**
 * A wrapper around explicit lock creation that lets you control whether marscoinj performs cycle detection or not.
 */
public class Locks {

    static {
        // Default policy goes here. If you want to change this, use one of the static methods before
        // instantiating any marscoinj objects. The policy change will take effect only on new objects
