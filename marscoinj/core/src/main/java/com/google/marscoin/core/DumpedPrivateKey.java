...
/**
 * Parses and generates private keys in the form used by the marscoin "dumpprivkey" command. This is the private key
...
public class DumpedPrivateKey extends VersionedChecksummedBytes {
    ...
    /**
     * Parses the given private key as created by the "dumpprivkey" marscoin C++ RPC.
     *
