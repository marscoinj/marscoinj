...
import static com.google.marscoin.core.Utils.doubleDigest;
import static com.google.marscoin.core.Utils.scryptDigest;
import static com.google.marscoin.core.Utils.doubleDigestTwoBuffers;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the marscoin system.
 * It records a set of {@link Transaction}s together with some data that links it into a place in the global block
 * chain, and proves that a difficult calculation was done over its contents.
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so marscoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the marscoin wire format. */
    ...
    /**
     * Contruct a block object from the marscoin wire format.
    ...
    /**
     * <p>A utility method that calculates how much new marscoin would be created by the block at the given height.
     * The inflation of marscoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link com.google.marscoin.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    /** Returns the version of the block data structure as defined by the marscoin protocol. */
     ...
     * {@link com.google.marscoin.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the marscoin "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, BigInteger value) {
        ...
        coinbase.length = coinbase.marscoinSerialize().length;
