...
import com.google.marscoin.core.StoredBlock;
 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the marscoin serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.marscoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.marscoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
