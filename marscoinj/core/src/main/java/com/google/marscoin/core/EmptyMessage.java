 ...
 * Currently this includes getaddr, ping, verack as well as the special marscoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void marscoinSerializeToStream(OutputStream stream) throws IOException {
    }
