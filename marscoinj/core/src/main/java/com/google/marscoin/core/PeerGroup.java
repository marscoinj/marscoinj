...
import com.google.marscoin.core.Peer.PeerHandler;
import com.google.marscoin.discovery.PeerDiscovery;
import com.google.marscoin.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService {
    ...
    // pipeline with the marscoin serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.marscoin.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * peers. By using this with {@link com.google.marscoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.marscoin.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.marscoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the marscoin
     ...
     * times are available via {@link com.google.marscoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.marscoin.core.Peer#ping()}.
     */
