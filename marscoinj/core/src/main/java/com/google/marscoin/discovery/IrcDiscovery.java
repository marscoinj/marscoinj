...
package com.google.marscoin.discovery;

import com.google.marscoin.core.AddressFormatException;
import com.google.marscoin.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#marscoin" or "#marscoinTEST3" for the production and test networks
     *                respectively.
     */
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // marscoinj but not match the standard nick format, so full peers don't try and connect to us.
    ...
    static ArrayList<InetSocketAddress> parseUserList(String[] userNames) throws UnknownHostException {
        ...
        for (String user : userNames) {
            // All marscoin peers start their nicknames with a 'u' character.
            ...
            try {
                ...
                // so simply beginning with "u" does not imply this is a valid marscoin encoded address.
                //
