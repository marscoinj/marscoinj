...
/**
 * <p>Methods to serialize and de-serialize messages to the marscoin network format as defined in
 * </p>
 *
 ...
 * <li>Message.marscoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class marscoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(marscoinSerializer.class);
    ...
    /**
     * Constructs a marscoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public marscoinSerializer(NetworkParameters params) {
     ...
     */
    public marscoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("marscoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.marscoinSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A marscoin protocol message has the following format.
        //
        ...
        marscoinPacketHeader header = new marscoinPacketHeader(in);
     ...
     */
    public marscoinPacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new marscoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link marscoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(marscoinPacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class marscoinPacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public marscoinPacketHeader(InputStream in) throws ProtocolException, IOException {
