...
import static com.google.marscoin.core.Utils.COIN;
import static com.google.common.base.Preconditions.checkState;

/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a marscoin chain.</p>
 *
 * Currently there are only two, the production chain and the test chain. But in future as marscoin
...
public class NetworkParameters implements Serializable {
     ...
     */
    public static final int PROTOCOL_VERSION = 70020;
    ...
    public static final String ID_PRODNET = "org.marscoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.marscoin.test";
    /** Unit test network. */
    static final String ID_UNITTESTNET = "com.google.marscoin.unittest";
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all marscoin implemenetations. For a
    ...
    /** How many blocks pass between difficulty adjustment periods. marscoin standardises this to be 2015. */
    public /*final*/ int interval;
    /**
     * How much time in seconds is supposed to pass between "interval" blocks. If the actual elapsed time is
     * significantly different from this value, the network difficulty formula will produce a different value. Both
     * test and production marscoin networks use 2 weeks (1209600 seconds).
     */
    ...
    private NetworkParameters(int type) {
        ...
        if (type == 0 || type == 100 || type == 3 || type == 2 || type == -1) {
            // Production.
            ...
            addressHeader = 50;
            if(type == 100) port = 8338;
            else port = 8338;
            packetMagic = 0xfbc0b6db;
            genesisBlock.setDifficultyTarget(0x1e0ffff0L);
            genesisBlock.setTime(1388590627L);
            ...
            checkState(genesisHash.equals("06e005f86644f15d2e4c62b59a038c798a3b0816ba58dcc8c91e02ce5a685299"),
                    genesisHash);
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            byte[] bytes = Hex.decode
                    ("466f726265732033302f4465632f32303133205468652059656172206f6620426974636f696e");
            t.addInput(new TransactionInput(n, t, bytes));
            //ByteArrayOutputStream scriptPubKeyBytes = new ByteArrayOutputStream();
            //Script.writeBytes(scriptPubKeyBytes, Hex.decode("0"));
    ...
    /** The primary marscoin chain created by Satoshi. */
    ...
    /** The primary marscoin chain created by pipi. */
