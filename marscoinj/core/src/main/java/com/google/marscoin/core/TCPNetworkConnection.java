...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a marscoin node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private marscoinSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new marscoinSerializer(this.params);
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // marscoinj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a marscoin message passing upstream in the channel.
        //
        ...
        /** Serialize outgoing marscoin messages passing downstream in the channel. */
    ...
    /** Returns the Netty Pipeline stage handling marscoin serialization for this connection. */
