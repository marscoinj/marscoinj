...
import com.google.marscoin.core.Block;
import com.google.marscoin.core.FullPrunedBlockChain;
import com.google.marscoin.core.NetworkParameters;
import com.google.marscoin.core.Utils;
import com.google.marscoin.store.FullPrunedBlockStore;
...
public class BlockImporter {
    public static void main(String[] args) throws Exception {
        ...
        if (System.getProperty("os.name").toLowerCase().indexOf("win") >= 0) {
            defaultDataDir = System.getenv("APPDATA") + "\\.marscoin/";
        } else {
            defaultDataDir = System.getProperty("user.home") + "/.marscoin/";
        }
