...
public class Constants
{
	...
	private static final String EXTERNAL_WALLET_KEY_BACKUP_PROD = "marscoin-wallet-keys";
	private static final String EXTERNAL_WALLET_KEY_BACKUP_TEST = "marscoin-wallet-keys-testnet";
	...
	private static final String BLOCKCHAIN_SNAPSHOT_FILENAME_PROD = "blockchainmrs-snapshot.jpg";
	private static final String BLOCKCHAIN_SNAPSHOT_FILENAME_TEST = "blockchainmrs-snapshot-testnet.jpg";
	...
	private static final String BLOCKCHAIN_FILENAME_PROD = "blockchainmrs";
	private static final String BLOCKCHAIN_FILENAME_TEST = "blockchainmrs-testnet";
	public static final String BLOCKCHAIN_FILENAME = TEST ? BLOCKCHAIN_FILENAME_TEST : BLOCKCHAIN_FILENAME_PROD;

	public static final String PEER_DISCOVERY_IRC_CHANNEL_PROD = "#marscoin";
	public static final String PEER_DISCOVERY_IRC_CHANNEL_TEST = "#marscoinTEST3";

	private static final String BLOCKEXPLORER_BASE_URL_PROD = "http://explore.marscoin.org/";
	private static final String BLOCKEXPLORER_BASE_URL_TEST = "http://explore.marscoin.org/";
	public static final String BLOCKEXPLORER_BASE_URL = TEST ? BLOCKEXPLORER_BASE_URL_TEST : BLOCKEXPLORER_BASE_URL_PROD;

	public static final String MIMETYPE_TRANSACTION = "application/x-mrstx";

	public static final int MAX_NUM_CONFIRMATIONS = 7;
	public static final String USER_AGENT = "Marscoin Wallet";
	...
	public static final String CURRENCY_CODE_MARSCOIN = "MRS";
	...
	public static final int LOCAL_PRECISION = 8; //default 4, temporary for MRS is 8

	public static final String DONATION_ADDRESS = "MSoReX5A3E75BpHomTbtG91Qu765nr3ZTy";
	public static final String REPORT_EMAIL = "support@pooler.cc";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/marscoinj/";
	public static final String BINARY_URL = "http://hlds.ws/marscoinj/wallet.apk";
	public static final String CREDITS_MARSCOINJ_URL = "https://github.com/marscoinj/";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
	public static final String CREDITS_ICON_URL = "http://marscoin.org";
	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/#!/marscoin";
	public static final String AUTHOR_GOOGLEPLUS_URL = "https://profiles.google.com/marscoin";
	public static final String MARKET_APP_URL = "market://details?id=%s";
	public static final String WEBMARKET_APP_URL = "https://play.google.com/store/apps/details?id=%s";
	public static final String MARKET_PUBLISHER_URL = "market://search?q=pub:\"Marscoin\"";

	private static final String VERSION_URL_PROD = "http://hlds.ws/version";
	private static final String VERSION_URL_TEST = "http://hlds.ws/version_test";
