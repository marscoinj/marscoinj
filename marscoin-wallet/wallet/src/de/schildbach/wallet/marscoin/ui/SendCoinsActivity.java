...
public final class SendCoinsActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		if ((Intent.ACTION_VIEW.equals(action) || NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) && intentUri != null && "marscoin".equals(scheme))
		{
			try
			{
				final marscoinURI marscoinUri = new marscoinURI(null, intentUri.toString());
				address = marscoinUri.getAddress().toString();
				addressLabel = marscoinUri.getLabel();
				amount = marscoinUri.getAmount();
			}
