...
import de.schildbach.wallet.marscoin.util.CrashReporter;
import de.schildbach.wallet.marscoin.util.EncryptionUtils;
import de.schildbach.wallet.marscoin.util.IOUtils;
import de.schildbach.wallet.marscoin.util.Iso8601Format;
...
public final class WalletActivity extends AbstractWalletActivity
{
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
        ...
        //checkUpdateNotify(); DISABLE TEMORARY
	}
    ...
    private void checkUpdateNotify() {
        ...
        for (PackageInfo pi : packages) {
            if(pi.packageName.equals("marscoin.wallet_mrs") &&
                    pi.versionCode >= 150) {
                ...
                if(args.getInt("next") == DIALOG_NEXT_GET_NEW_APP) {
                    ...
                    builder
                        ...
                        .setNeutralButton(R.string.button_install_new_app, new OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                intent.setData(Uri.parse("market://details?id=de.schildbach.wallet_mrs"));
                                startActivity(intent);
                            }
                        });
                    ...
                    builder
                        ...
                        .setNeutralButton(R.string.button_import_into_new_app, new OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                // Throw import intent to marscoin app
                                Intent sendIntent = new Intent();
                                sendIntent.setAction(Intent.ACTION_VIEW);
                                Uri uri = Uri.fromFile(file);
                                Log.i(TAG, "URI to file: " + uri);
                                sendIntent.setDataAndType(uri, "x-marscoin/private-keys");
