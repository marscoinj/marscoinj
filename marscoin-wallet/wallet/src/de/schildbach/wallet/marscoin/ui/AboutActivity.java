...
import com.google.marscoin.core.VersionMessage;
...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_MARSCOINJ = "about_credits_marscoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_MARSCOINJ).setTitle(getString(R.string.about_credits_marscoinj_title, VersionMessage.MARSCOINJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_MARSCOINJ).setSummary(Constants.CREDITS_MARSCOINJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_MARSCOINJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_MARSCOINJ_URL)));
			finish();
		}
