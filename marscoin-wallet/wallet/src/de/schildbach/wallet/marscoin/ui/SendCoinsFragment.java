...
package de.schildbach.wallet.marscoin.ui;
...
import com.google.marscoin.core.Wallet.SendRequest;
...
import de.schildbach.wallet.marscoin.AddressBookProvider;
import de.schildbach.wallet.marscoin.Constants;
import de.schildbach.wallet.marscoin.WalletApplication;
import de.schildbach.wallet.marscoin.integration.android.marscoinIntegration;
import de.schildbach.wallet.marscoin.service.BlockchainService;
import de.schildbach.wallet.marscoin.service.BlockchainServiceImpl;
...
public final class SendCoinsFragment extends SherlockFragment implements AmountCalculatorFragment.Listener
{
	...
	private final CurrencyAmountView.Listener amountsListener = new CurrencyAmountView.Listener()
	{
		...
		{
			dismissPopup();
            Log.d("marscoin", "Amount: " + amountView.getAmount() + ", Fee: " + feeView.getAmount());
		...
		viewGo.setOnClickListener(new OnClickListener()
		{
			...
			private void feeDialog()
			{
				...
				dialog.setMessage(getString(R.string.send_coins_dialog_fee_message,
						Constants.CURRENCY_CODE_MARSCOIN + " " + WalletUtils.formatValue(Constants.DEFAULT_TX_FEE, Constants.LTC_PRECISION)));
				if (allowLowFee)
				{
	...
	private void popupAvailable(final View anchor, final BigInteger available, final BigInteger pending)
	{
		...
		viewAvailable.setPrefix(Constants.CURRENCY_CODE_MARSCOIN);
	...
	private void handleGo()
	{
		...
		backgroundHandler.post(new Runnable()
		{
			public void run()
			{
                ...
                Log.d("marscoin", "Transaction size is " + txSize);
                /* From official marscoin wallet.cpp
                ...
                */
                ...
                {
                    Log.i("marscoinSendCoins", "Recalculated fee: " +
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        try {
                                            ...
                                            Log.i("marscoinSendCoins", "VerificationException: " + e);
                                            return;
                                        }
                                        // Fees are agreeable
    ...
    class TransactionRunnable implements Runnable {
        ...
        public void run()
        {
            ...
            marscoinIntegration.transactionHashToResult(result, sentTransaction.getHashAsString());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (scanResult != null) {
            marscoinURI uri = WalletUtils.parseAddressString(scanResult.getContents());
            if(uri != null)
