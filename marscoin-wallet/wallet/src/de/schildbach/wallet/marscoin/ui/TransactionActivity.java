...
import com.google.marscoin.core.ProtocolException;
import com.google.marscoin.core.Sha256Hash;
import com.google.marscoin.core.Transaction;
import com.google.marscoin.core.VerificationException;
...
import de.schildbach.wallet.marscoin.util.Base43;
...
public final class TransactionActivity extends AbstractWalletActivity
{
	...
	private void updateView()
	{
		...
		if (nfcManager != null)
			NfcTools.publishMimeObject(nfcManager, this, Constants.MIMETYPE_TRANSACTION, tx.unsafemarscoinSerialize(), false);
	}
