...
import de.schildbach.wallet.marscoin.util.BitmapFragment;
import de.schildbach.wallet.marscoin.util.NfcTools;
...
public final class WalletAddressFragment extends Fragment
{
	...
	private View marscoinAddressButton;
	private TextView marscoinAddressLabel;
	private ImageView marscoinAddressQrView;
	...
	private void updateView()
	{
		...
		if (!selectedAddress.equals(lastSelectedAddress))
		{
			...
			marscoinAddressLabel.setText(WalletUtils.formatAddress(selectedAddress, Constants.ADDRESS_FORMAT_GROUP_SIZE,
					Constants.ADDRESS_FORMAT_LINE_SIZE));

			final String addressStr = marscoinURI.convertTomarscoinURI(selectedAddress, null, null, null);

			final int size = (int) (256 * getResources().getDisplayMetrics().density);
			qrCodeBitmap = WalletUtils.getQRCodeBitmap(addressStr, size);
			marscoinAddressQrView.setImageBitmap(qrCodeBitmap);
