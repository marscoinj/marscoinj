...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
                ...
                try {
                    ...
                    Log.e("marscoin", "marscoinj issue.  We're going to ignore this for now and just try and return nicely.");
                    return;
                }
	...
	public void notifyWidgets()
	{
        ...
        try {
            ...
            Log.e("marscoin", "App server appears dead - Runtime Exception when running getAppWidgetIds.  Returning..");
            return;
        }
