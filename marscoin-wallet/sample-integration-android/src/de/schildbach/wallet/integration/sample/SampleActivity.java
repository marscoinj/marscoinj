...
{
	private static final String DONATION_ADDRESS = "1SoReXQ16kcVCNif4no1hnnLMsfYwYKj8"; // prodnet
	// private static final String DONATION_ADDRESS = "MSoReX5A3E75BpHomTbtG91Qu765nr3ZTy"; // testnet
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		donateButton.setOnClickListener(new OnClickListener()
		{
			...
			{
				marscoinIntegration.requestForResult(SampleActivity.this, REQUEST_CODE, DONATION_ADDRESS);
			}
		});
	...
	protected void onActivityResult(final int requestCode, final int resultCode, final Intent data)
	{
		if (requestCode == REQUEST_CODE)
		{
			...
			{
				final String txHash = marscoinIntegration.transactionHashFromResult(data);
				if (txHash != null)
				{
